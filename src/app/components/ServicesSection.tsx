  ...
  const services = [
    {
      ...
      image: "/massage.webp?height=400&width=400",
    },
    {
      title: "Rejuvenating Facials",
      description: "Revitalize your skin with cutting-edge facial treatments.",
      image: "/facials.webp?height=400&width=400",
    },
    {
      title: "Stunning Lash Extensions",
      description: "Enhance your natural beauty with premium lash services.",
      image: "/lash-extensions.webp?height=400&width=400",
    },
    {
      title: "Glowing Spray Tans",
      description: "Enhance your natural beauty with premium lash services.",
      image: "/spray-tan.webp?height=400&width=400",
    },
    {
      title: "Premium Permanent Makeup",
      description: "Enhance your natural beauty with premium lash services.",
      image: "/permanent-makeup.webp?height=400&width=400",
    },
    {
      title: "Tantalizing Waxing",
      description: "Enhance your natural beauty with premium lash services.",
      image: "/waxing.webp?height=400&width=400",
    },
  ]

  return (
    <section id="services" className="w-full py-24 bg-blue-500 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-12">
          {services.map((service, index) => (
            <div key={index} className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg p-6 text-white">
              ...
              <Button variant="default" className="w-full border-white text-white hover:bg-white hover:text-blue-600">
                Learn More
              </Button>
            </div>
          ))}
